...
const STYLES = `
  body { font-family: -apple-system, system-ui, sans-serif; margin: 0; color: #c9d1d9; background: #0d1117; }
  main { max-width: 1180px; margin: 0 auto; padding: 24px 24px 0; width: 100%; }
